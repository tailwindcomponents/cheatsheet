    ...
    return (
        <div className="bg-white border-b lg:fixed lg:w-full lg:top-0 lg:left-0">
            <div className="container p-4 mx-auto">
                <div className="flex flex-col lg:justify-center lg:items-center lg:flex-row lg:space-x-4">
                ...
                <div className="flex justify-center mt-6">
                    <a className="flex items-center space-x-2 text-gray-700 hover:text-primary hover:underline" href="https://github.com/tailwindcomponents/cheatsheet">
