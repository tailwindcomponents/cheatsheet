            ...
            <div className="container p-4 mx-auto">
                <div className="flex flex-col lg:items-center lg:justify-center lg:flex-row lg:space-x-4">
                    ...
                    <div className="flex flex-col mt-4 space-y-3 lg:mt-0 sm:flex-row sm:space-y-0 sm:space-x-3 sm:items-center sm:justify-center">
                        ...
                        <a title="TailwindCSS" href="https://tailwindcomponents.com/" className="px-4 py-2 font-semibold text-center text-white transition-colors duration-300 transform rounded-md bg-primary hover:bg-teal-300">Back <span className="lg:hidden xl:inline">to components</span></a>
                        <a className="flex items-center justify-center space-x-2 text-gray-700 transition-colors duration-500 transform hover:text-primary hover:underline" href="https://github.com/tailwindcomponents/cheatsheet">
